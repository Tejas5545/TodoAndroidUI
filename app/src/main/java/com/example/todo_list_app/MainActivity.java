...
public class MainActivity extends BaseActivity implements CreateTaskBottomSheetFragment.setRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTask.setOnClickListener(view -> {
            ...
            createTaskBottomSheetFragment.setTaskId(0, false, (CreateTaskBottomSheetFragment.setRefreshListener) this, MainActivity.this);
    ...
    public void setUpAdapter() {
        taskAdapter = new TaskAdapter(this, tasks, (CreateTaskBottomSheetFragment.setRefreshListener) this);
